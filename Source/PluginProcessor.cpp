...
const juce::String SoundfontPlayerAudioProcessor::getProgramName (int index)
{
    return {};
}

void SoundfontPlayerAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void SoundfontPlayerAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
void SoundfontPlayerAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
